pipeline {
    ...
    stages {
        ...
        stage('Deploy to Docker Host') {
          steps {
            sh    'docker -H tcp://10.1.1.200:2375 stop c || true'
            sh    'docker -H tcp://10.1.1.200:2375 run --rm -dit --name featurewebapp1 --hostname featurewebapp1 -p 8000:80 sreeharshav/pipelinetestprod:${BUILD_NUMBER}'
            }
        }
